...
export const WIZARD_CONFIG: Record<WorldSlug, WizardConfig> = {
  ...
  explorer: {
    ...
    samplePlan: {
      ...
      weeks: [
        { label: "Day 1", date: "Today", title: "Lava-cake science: chemical reactions", methods: "hook · explain · build" },
        { label: "Day 2", date: "Tomorrow", title: "Cross-section anatomy: magma chamber to vent", methods: "drawing · labelling" },
        { label: "Day 3", date: "Day after", title: "Case study: Kīlauea — real eruption", methods: "video · recall" },
      ],
      methods: [
        { icon: "🎬", title: "Dual coding", reason: "video + text recall better than either alone" },
  ...
  builder: {
    ...
    outcomeOptions: ["🚀 Ship to GitHub", "🎬 Demo video", "👫 Show 3 friends", "🏅 Hackathon entry"],
    tutorWhisper:
    ...
    samplePlan: {
      ...
      weeks: [
        { label: "Wk 1", date: "May 21–27", title: "Add / subtract / multiply / divide functions", methods: "worked → twin · pytest" },
        { label: "Wk 2", date: "May 28–Jun 3", title: "Edge cases · PyQt UI · publish", methods: "Socratic · refactor · ship" },
      ],
  ...
  scholar: {
    ...
    samplePlan: {
      ...
      weeks: [
        { label: "Wk 1", date: "May 21–25", title: "Unit circle + radians (foundations)", methods: "hook · explain · drill" },
        { label: "Wk 2", date: "May 26–Jun 1", title: "Sine, cosine, tangent · graphs", methods: "interleave · worked twin" },
        { label: "Wk 3", date: "Jun 2–8", title: "Identities — your diagnosed weak spot", methods: "Socratic · spaced cards", highlight: true },
        { label: "Wk 4", date: "Jun 9–13", title: "Mixed SAT-style practice + review", methods: "active recall · timed sprints" },
        { label: "Exam", date: "Jun 14", title: "SAT Math · trig subset · 12 questions", methods: "real test", dim: true },
      ],
      methods: SHARED_METHODS,
      projection: { value: "720", unit: "SAT Math · trig section", note: "Beats your goal (≥700) by 20 — projection from diagnostic + plan adherence." },
    },
  },
  adult: {
    slug: "adult",
    ...
    samplePlan: {
      ...
      weeks: [
        { label: "Wk 1", date: "May 21–25", title: "VPC fundamentals — subnets, route tables, NAT", methods: "explain · worked twin", highlight: true },
        { label: "Wk 2", date: "May 28–Jun 1", title: "IAM, KMS, security best practice", methods: "drill · cite-the-doc" },
        { label: "Wk 3", date: "Jun 4–8", title: "Storage (S3, EBS, EFS) + cost models", methods: "compare-and-contrast" },
        { label: "Wk 4", date: "Jun 11–15", title: "High-availability + DR scenarios", methods: "case study · Socratic" },
        { label: "Wk 5", date: "Jun 18–22", title: "Full timed mocks + flag review", methods: "active recall · spaced" },
      ],
      methods: SHARED_METHODS,
      projection: { value: "82%", unit: "projected mock-exam score", note: "Above SAA-C03 cut score (72%). Strongest domain: Design Secure Architectures." },
    },
  },
  senior: {
    slug: "senior",
    ...
    samplePlan: {
      ...
      weeks: [
        { label: "Day 1", date: "Today", title: "The 5 tells of a scam message", methods: "video · plain language" },
        { label: "Day 2", date: "Tomorrow", title: "Real examples — yes or no?", methods: "active recall · gentle" },
        { label: "Day 3", date: "Day 3", title: "What to do if you're not sure", methods: "scenario · safe-side rules" },
      ],
      methods: [
