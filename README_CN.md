...
| 世界 | 年龄 | 界面形式 | 示例课程 |
|---|---|---|---|
| 🎒 **六年级 (预备班)** | 11–12 | 故事与基础认知 | 沪教版六年级数学 - 分数的运算 |
| 🔬 **七年级 (初一)** | 12–13 | 科学启蒙、阅读任务 | 沪教版七年级生命科学 - 显微镜的使用 |
| 🧲 **八年级 (初二)** | 13–14 | 项目挑战、理科逻辑 | 沪科版八年级物理 - 光的折射与反射 |
| 🧪 **九年级 (初三)** | 14–15 | 备考冲刺、跨学科强化 | 沪教版九年级化学 - 溶液的酸碱性 |
| 🎓 **高中及以上 (Professional)** | 15+ | 路径、深度学习 | 高中数学 - 三角函数核心突破特训 |
| 👨‍🏫 **教研与家长 (Senior)** | 成人 | 分析、策略指导 | 如何帮助孩子做好初高中衔接 |
