...
export default function LearnerShell({
  ...
  return (
    <main id="main" className={`min-h-screen bg-gradient-to-b ${toneClasses[tone]}`}>
      <header className="border-b border-black/5 bg-white/80 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              href="/login"
              className="rounded-lg px-3 py-2 text-sm font-medium text-gray-600 hover:text-primary"
              title="Optional — sign in to sync progress across devices"
            >
              Sign in
            </Link>
          </div>
