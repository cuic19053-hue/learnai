          ...
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-4xl">
              ...
              <p className="mb-6 text-lg leading-relaxed text-gray-700">
                LearnAI is dedicated to democratizing access to quality education by connecting
                students with expert professors from around the world. We believe that everyone
                deserves access to personalized, high-quality learning experiences, regardless of
                their location or circumstances.
              </p>
              <p className="mb-6 text-lg leading-relaxed text-gray-700">
                Our AI-powered platform intelligently matches students with the perfect professor
                based on their learning style, subject needs, and schedule. With integrated
                whiteboard technology and seamless payment processing, we make it easy for students
                to learn and professors to teach.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Only 10% platform fee - professors keep 90% of earnings
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="mx-auto max-w-3xl text-center">
              ...
              <div className="rounded-xl border-2 border-yellow-400 bg-gradient-to-r from-yellow-400 to-orange-400 p-8">
                ...
                <p className="mb-6 text-gray-900">
                  If you find LearnAI useful, please consider starring the repository on GitHub!
              ...
              <div className="mt-12 rounded-xl bg-white bg-opacity-10 p-6 backdrop-blur-sm">
                ...
                <p className="mb-4 text-gray-300">
                  Looking for AI-powered solutions, full-stack development, or educational
                  technology consulting? Ruslan is available for freelance projects and consulting.
                </p>
                <a
                  href="https://ruslanmv.com"
                  target="_blank"
