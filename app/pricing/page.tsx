              ...
              <div className="space-y-6">
                <div className="rounded-lg bg-white p-6 shadow-md">
                  ...
                  <p className="text-gray-600">
                    Students pay per session through PayPal. Professors receive 90% of the session
                    fee directly to their PayPal account. LearnAI takes only a 10% platform fee to
                ...
                <div className="rounded-lg bg-white p-6 shadow-md">
                  ...
                  <p className="text-gray-600">
                    Yes! You can browse professor profiles, read reviews, and use our AI matching
                    system for free. You only pay when you book and complete a session.
                  </p>
                </div>
                ...
                <div className="rounded-lg bg-white p-6 shadow-md">
                  ...
                  <p className="text-gray-600">
                    We have a satisfaction guarantee. If you're not happy with your first session
                    with a professor, contact our support team within 24 hours for a full refund.
                  </p>
                </div>
                ...
                <div className="rounded-lg bg-white p-6 shadow-md">
                  ...
                  <p className="text-gray-600">
                    Professors set their own hourly rates based on their expertise, experience, and
                    market demand. Rates typically range from $30 to $100 per hour, but professors
                    are free to charge what they believe their time is worth.
                  </p>
                </div>
              </div>
            </div>
