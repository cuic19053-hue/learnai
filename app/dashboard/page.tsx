      ...
      <AppLayout>
        <div className="container mx-auto space-y-8 px-4 py-10">
          ...
          <div className="rounded-xl border-2 border-primary bg-blue-50 p-6">
            <h3 className="mb-3 text-xl font-bold text-gray-900">Ready to Start Learning? 🎓</h3>
            <p className="mb-4 text-gray-700">Create your free account to unlock all features:</p>
        ...
        {isAdmin && (
          <section className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
            ...
            <p className="text-sm text-gray-600">
              ...
              recruitment pipeline. A future version can expose CSV export and direct HR
              integrations.
            </p>
          </section>
        )}
