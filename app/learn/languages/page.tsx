  ...
  return (
    ...
    >
      ...
      <p className="mt-1 max-w-[720px] text-[15px] text-ink-soft">
        Seven languages. Four CEFR levels — A1 to B2. We focus on the practical floor of fluency:
        from your first words to confident, independent use.
      </p>
      ...
      <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {LANGUAGES.map((lang) => (
          ...
          >
            ...
            <p className="mt-2 flex-1 text-[13px] leading-relaxed text-ink-soft">{lang.blurb}</p>
            <span
      ...
      <p className="mt-10 max-w-[760px] text-[12px] leading-relaxed text-ink-mute">
        Curriculum based on the public CEFR framework (Council of Europe). Mock tests are
        CEFR-aligned originals — they are not affiliated with, endorsed by, or compatible
        substitutes for TOEFL, IELTS, JLPT, HSK, DELE, TestDaF, TORFL, or any other proprietary
