...
import WikiReportView from "@/components/wiki/WikiReportView";
...
export async function generateMetadata({
  ...
  return test
    ? {
        title: `Report — ${test.article.title}`,
        description: "Your readiness scorecard with per-section accuracy.",
      }
...
export default async function WikiReportPage({
  ...
  return (
    ...
    >
      ...
      <div className="mt-6">
        <WikiReportView test={test} worldSlug={world.slug} />
      </div>
    </LearnerHomeShell>
  );
}
