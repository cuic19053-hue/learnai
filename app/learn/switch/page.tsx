  ...
  return (
    <main id="main" className="min-h-screen bg-white">
      ...
      <section className="mx-auto max-w-[1200px] px-6 py-12 md:px-10 md:py-16">
        <p className="la-mono text-xs font-bold tracking-wider text-brand-1">SWITCH WORLD</p>
        ...
        <p className="mt-3 max-w-[640px] text-base leading-relaxed text-ink-soft">
          Six worlds, one engine. Click any card to land directly in that world&apos;s dashboard —
          no setup, no questions, no sign-in.
        </p>
        ...
        <p className="mt-10 text-[13px] text-ink-mute">
          Want a guided setup with goal, teacher persona, and a 5-min first lesson?{" "}
          <Link href="/onboarding" className="font-semibold text-brand-1 hover:underline">
